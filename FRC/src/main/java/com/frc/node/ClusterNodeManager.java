...
public class ClusterNodeManager {
    ...
    public boolean nodeAdd(long logIndex, RedisInfo redisInfo) {
        ...
        try {
            FRCLogger.getInstance().info(logIndex, flag, "add:{}", null,
    ...
    public boolean nodeUpdate(long logIndex, RedisInfo redisInfo) {
        ...
        try {
            FRCLogger.getInstance().info(logIndex, flag, "update:{}", null,
                JSONProvider.toJSONString(logIndex, redisInfo));
    ...
    public boolean nodeRemove(long logIndex, RedisInfo redisInfo) {
        ...
        try {
            FRCLogger.getInstance().info(logIndex, flag, "remove:{}", null,
                JSONProvider.toJSONString(logIndex, redisInfo));
