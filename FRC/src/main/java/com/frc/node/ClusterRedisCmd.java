...
public class ClusterRedisCmd {
    ...
    public ResBool set(long logIndex, String key, String val) {
        ...
        try {
            RedisClient redisClient = ClusterAlgo.getCurrentRedis(logIndex, key);
            if (null == redisClient) {
                FRCLogger.getInstance().warn(logIndex, flag,
                    "cannot locate the redis key:{} val:{}", null, key, val);
            ...
            boolean bret = false;
            RedisClient target_redis = ClusterAlgo.migrateDB(logIndex, key, redisClient);
            ...
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} val:{}", e, key, val);
    ...
    public ResStr get(long logIndex, String key) {
        ...
        try {
            ...
            RedisClient redisClient = ClusterAlgo.getCurrentRedis(logIndex, key);
            if (null == redisClient) {
                FRCLogger.getInstance().warn(logIndex, flag, "cannot locate the redis key:{} ",
                    null, key);
    ...
    public ResListStr hmget(long logIndex, String key, List<String> fields) {
        ...
        try {
            ...
            RedisClient target_redis = ClusterAlgo.migrateDB(logIndex, key, redisClient);
            ret = target_redis.hmget(logIndex, key, (String[]) fields.toArray());
            if (null == ret || ret.size() == 0)
                res.res = ReturnValues.THRIFT_CODE_FAIL;
            else
                res.res = ReturnValues.THRIFT_CODE_SUCC;
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = null;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} fields:{} ", e, key, fields);
            return res;
        }
    }
    ...
    public ResBool hdel(long logIndex, String key, String field) {
        ...
        try {
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = false;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} fields:{} ", e, key, field);
            return res;
        }
    }

    public ResBool zadd(long logIndex, String key, Map<String, Double> scoreMembers) {
        ...
        try {
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = false;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} fields:{} scoreMembers:{} ", e,
                key, scoreMembers);
            return res;
        }
    }
    ...
    public ResBool zadd(long logIndex, String key, double score, String member) {
        ...
        try {
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = false;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} fields:{} score:{} member:{} ", e,
                key, score, member);
            return res;
        }
    }
    ...
    public ResBool zrem(long logIndex, String key, String[] members) {
        ...
        try {
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = false;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} key:{}   member:{} ", e, key,
                members);
            return res;
        }
    ...
    public ResSetStr zrange(long logIndex, String key, long start, long end) {
        ...
        try {
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = null;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} key:{}  start:{} end:{} ", e, key,
                start, end);
            return res;
        }
    }
    ...
    public ResDouble zscore(long logIndex, String key, String member) {
        ...
        try {
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = 0.0;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} key:{}  start:{} member:{} ", e,
                key, member);
            return res;
        }
    }
    ...
    public ResBool exists(long logIndex, String key) {
        ...
        try {
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = false;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} key:{}  start:{} ", e, key);
            return res;
        }
    }
    ...
    public ResBool setnx(long logIndex, String key, String value, int expired_time) {
        ...
        try {
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = false;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} key:{}  value:{} expired_time:{} ",
                e, key, value, expired_time);
            return res;
        }
    }
    ...
    public ResBool lpush(long logIndex, String key, String[] strings) {
        ...
        try {
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = false;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} key:{}  value:{} strings:{} ", e,
                key, strings);
            return res;
        }
    }
    ...
    public ResBool expired(long logIndex, String key, int seconds) {
        ...
        try {
            ...
            res.res = ReturnValues.THRIFT_CODE_EXCPETION;
            res.value = false;
            FRCLogger.getInstance().warn(logIndex, flag, "key:{} key:{}  value:{} seconds:{} ", e,
                key, seconds);
            return res;
        }
    }
