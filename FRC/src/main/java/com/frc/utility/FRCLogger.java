...
public class FRCLogger {
     ...
     * */
    private void log(long logIndex, int level, String msg, Throwable t,
	    String flag, Object... args) {
	try {
	    Object argArray[];
	    int len = args.length;
	    if (len > 0) {
    ...
    public void info(long logIndex, String flag, String msg, Throwable t,
	    Object... args) {
	this.log(logIndex, this.LEVEL_INFO, msg, t, flag, args);
    }

    public void debug(long logIndex, String flag, String msg, Throwable t,
	    Object... args) {
	this.log(logIndex, this.LEVEL_DEBUG, msg, t, flag, args);
    }

    public void warn(long logIndex, String flag, String msg, Throwable t,
	    Object... args) {
	this.log(logIndex, this.LEVEL_WARN, msg, t, flag, args);
    }

    public void error(long logIndex, String flag, String msg, Throwable t,
	    Object... args) {
	this.log(logIndex, this.LEVEL_ERROR, msg, t, flag, args);
    }

    public void trace(long logIndex, String flag, String msg, Throwable t,
	    Object... args) {
