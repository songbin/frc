...
public class RedisClient {
    ...
    public boolean init(long logIndex, RedisInfo redisInfo) {
        ...
        try {
            ...
            config.setMaxWaitMillis(PropertiesLoader.getIntance().getRedisMaxWait());
            // config.setMinEvictableIdleTimeMillis(PropertiesLoader.getIntance().getre);
            // config.setMinIdle(minIdle);
            config.setTestOnBorrow(PropertiesLoader.getIntance().getRedisTestBorrow());
            config.setTestOnReturn(PropertiesLoader.getIntance().getRedisTestReturn());

            if (StringUtils.isBlank(this.redis_passwd)) {
                jedisPool = new JedisPool(config, this.redis_host, this.redis_port);
            } else {
                jedisPool = new JedisPool(config, this.redis_host, this.redis_port, 2000,
                    this.redis_passwd);
            }
            return true;
        } catch (Exception e) {
    ...
    public String getRedisInfo(long logIndex) {
        ...
        return sb.append(this.redis_host).append(":").append(this.redis_port).toString();
    }
    ...
    public void shutDown(long logIndex) {
        ...
        try {
            ...
            FRCLogger.getInstance().warn(logIndex, flag, "shutting down jedis...", ex);
        }
    }
    ...
    public Long incr(long logIndex, String key) {
        ...
        try {
            ...
            FRCLogger.getInstance().warn(logIndex, flag, "parameters: key {}", e, key);
    ...
    // sorted set
    // ////////////////////////////////////////////////////////
    public boolean zadd(long logIndex, String key, Map<String, Double> scoreMembers) {
        ...
        try {
            ...
            if (null == scoreMembers || 0 == scoreMembers.size()) {
                return true;
            }
    ...
    public boolean zrem(long logIndex, String key, String[] members) {
        ...
        try {
            ...
            FRCLogger.getInstance().warn(logIndex, flag, "key {}, members {}", e, key,
                java.util.Arrays.toString(members));
    ...
    public Set<String> zrevrange(long logIndex, String key, long start, long end) {
        ...
        try {
            ...
            FRCLogger.getInstance().warn(logIndex, flag, "parameters: key {}, start {}, end {}", e,
                key, start, end);
            res = null;
            jedisPool.returnBrokenResource(jds);
        }
    ...
    public Double zscore(long logIndex, String key, String member) {
        ...
        try {
            ...
            FRCLogger.getInstance().warn(logIndex, flag, "parameters: key {} member:{}", e, key,
                member);
            jedisPool.returnBrokenResource(jds);
            return null;
        }
    ...
    public boolean set(long logIndex, String key, String value) {
        ...
        try {
            ...
            FRCLogger.getInstance().warn(logIndex, flag, "parameters: key {} value:{}", e, key,
                value);
            jedisPool.returnBrokenResource(jds);
    ...
    public String scriptLoad(long logIndex, String script) {
        ...
        try {
            ...
            jedisPool.returnBrokenResource(jds);
            FRCLogger.getInstance().warn(logIndex, flag, "parameters: script {} ", e, script);
    ...
    public Object eval(long logIndex, String script, int keyCount, String[] params) {
        ...
        try {
            ...
            FRCLogger.getInstance().warn(logIndex, flag,
                "parameters: script {}, keyCount:{}, params:{} ", e, script, keyCount,
    ...
    public List<String> lrange(long logIndex, String key, long start, long end) {
        ...
        try {
            ...
            jedisPool.returnBrokenResource(jds);
            FRCLogger.getInstance().warn(logIndex, flag, "key {}, start:{}, end:{}", e, key, start,
                end);
            return null;
        }
    }
    ...
    public Long lpush(long logIndex, String key, String[] strings) {
        ...
        try {
            ...
            jedisPool.returnBrokenResource(jds);
            FRCLogger.getInstance().warn(logIndex, flag, "key {}, strings:{}", e, key,
    ...
    public long expired(long logIndex, String key, int seconds) {
        ...
        try {
            ...
            jedisPool.returnBrokenResource(jds);
            FRCLogger.getInstance().warn(logIndex, flag, "key {}, seconds:{}", e, key, seconds);
            res = (long) 0;
            return res;
        }
    }
    ...
    public String migrate(long logIndex, String key, RedisClient dest) {
        ...
        try {
            ...
            FRCLogger.getInstance().warn(logIndex, flag, "key {}, redis:{}", null, key,
                JSONProvider.toJSONString(logIndex, dest));
            jedisPool.returnResource(jds);
            return res;
        } catch (Exception e) {
            jedisPool.returnBrokenResource(jds);
            FRCLogger.getInstance().warn(logIndex, flag, "key {}, redis:{}", e, key,
                JSONProvider.toJSONString(logIndex, dest));
    ...
    public String migrateEx(long logIndex, String key, String host, int port) {
        ...
        try {
            ...
            jedisPool.returnBrokenResource(jds);
            FRCLogger.getInstance().warn(logIndex, flag, "key {}, host:{} port:{}", e, key, host,
                port);
            res = CmdReturn.MIGRATE_EXCEPTION;
            return res;
        }
