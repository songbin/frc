...
public class FrcClient {
    ...
    public boolean hset(long logIndex, String key, String field, String value, String ext)
                                                                                          throws Exception {
    ...
    public boolean hmset(long logIndex, String key, Map<String, String> hash, String ext)
                                                                                         throws Exception {
    ...
    public List<String> hmget(long logIndex, String key, List<String> fields, String ext)
                                                                                         throws Exception {
    ...
    public boolean zadd(long logIndex, String key, Map<String, Double> scoreMembers, String ext)
                                                                                                throws Exception {
    ...
    public boolean zadd(long logIndex, String key, double score, String member, String ext)
                                                                                           throws Exception {
        String flag = this.getClassName() + ".zadd";
        RpcClient<Client> client = this.pool.getObject();
        try {
    ...
    public Set<String> zrange(long logIndex, String key, long start, long end, String ext)
                                                                                          throws Exception {
    ...
    public Set<String> zrevrange(long logIndex, String key, long start, long end, String ext)
                                                                                             throws Exception {
    ...
    public Set<String> zrevrangeByScore(long logIndex, String key, long start, long end, String ext)
                                                                                                    throws Exception {
    ...
    public List<String> lrange(long logIndex, String key, long start, long end, String ext)
                                                                                           throws Exception {
    ...
    public boolean setnx(long logIndex, String key, String value, int expired_time, String ext)
                                                                                               throws Exception {
